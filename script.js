// it makes a favourites meal array 
if (localStorage.getItem("favouritesList") == null) {
    localStorage.setItem("favouritesList", JSON.stringify([]));
}

// it fetchMeales meals from api 
async function fetchMeal(url,value) {
...
function showMealList(){
    ...
    let html = "";
    let meals=fetchMeal(url,inputValue);
    meals.then(data=>{
        if (data.meals) {
                ...
                <div id="card" class="card mb-3" style="width: 20rem;">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between mt-5">
                            <button type="button" class="btn btn-outline-light" onclick="showRcipe(${element.idMeal})">Get Recipe</button>
...
//it  shows recipe
async function showRcipe(id) {
    let url="https://www.themealdb.com/api/json/v1/1/lookup.php?i=";
    let html="";
    await fetchMeal(url,id).then(data=>{
    ...
    document.getElementById("main").innerHTML=html;
    document.getElementById("main").classList.add('showRecipe');
}
...
// it shows all favourite meal in wishlist
async function showFav() {
    ...
    if (arr.length==0) {
        ...
        for (let index = 0; index < arr.length; index++) {
            await fetchMeal(url,arr[index]).then(data=>{
                html += `
                <div id="card" class="card mb-3" style="width: 20rem;">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between mt-5">
                            <button type="button" class="btn btn-outline-light" onclick="showRcipe(${data.meals[0].idMeal})">Get Recipe</button>
    ...
    document.getElementById("wishlist-bar").innerHTML=html;
}
...
//it adds and remove meals from wishlist
